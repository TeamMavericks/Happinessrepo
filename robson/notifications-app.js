...
function GetEnrolments() {
	...
	var user = {
		...
		slackTeamWebHook: 'https://hooks.slack.com/services/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',
		slackChannel: 'sdm2018_team13',
		userName: 'Robson',
...
function startScheduler(slackWebHook, slackChannel, userName){
	...
	cron.scheduleJob(rule, function() {
		var slack = new lack(slackWebHook);
		slack.send({
